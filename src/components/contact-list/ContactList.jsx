...
export default function ContactList() {
    ...
    const items = contacts.map(contact => {    //contact = liste d'objets javascript, donc ici on a le premier contact on veut transformer la liste d'objets vers une liste de <li>
